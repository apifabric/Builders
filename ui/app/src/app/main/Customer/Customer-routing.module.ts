...
const routes: Routes = [
  ...
  { path: ':id', component: CustomerDetailComponent,
    ...
    path: ':recipient_id/Message', loadChildren: () => import('../Message/Message.module').then(m => m.MessageModule),
    data: {
        oPermission: {
    ...
    path: ':buyer_id/Order', loadChildren: () => import('../Order/Order.module').then(m => m.OrderModule),
    data: {
        oPermission: {
    ...
    path: ':seller_id/Product', loadChildren: () => import('../Product/Product.module').then(m => m.ProductModule),
    data: {
        oPermission: {
    ...
    path: ':customer_id/Wishlist', loadChildren: () => import('../Wishlist/Wishlist.module').then(m => m.WishlistModule),
    data: {
        oPermission: {
